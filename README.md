...
Laws marks with an asterix require forced-identification. Users with root access are technically able to bypass forced-identification checks and redefine the DOB and common age range value of all users.
#### Common age range 0
* `>=0 - <13`
* `>=13 - <16`
* `>=16 - <18`
...
* `dob_mgmt.sh` -> `/usr/sbin/age-verification/dob_mgmt.sh`
